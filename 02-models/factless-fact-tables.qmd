...
databases:
  - name: db
    path: "https://raw.githubusercontent.com/Alaburda/data-analyst-sql-cookbook/master/db/cookbookdb.sqlite"
---
...
con <- dbConnect(duckdb(), "../db/cookbook.duckdb", read_only = TRUE)
