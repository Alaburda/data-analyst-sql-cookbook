...
-- This is a factless fact table that counts the number of active subscribers
-- in a given month. It uses a date dimension to get the months and a subscriber
-- dimension to get the subscribers. The factless fact table is created by
