...
This is an important implication because your other options are either the IN operator or the WHERE EXISTS clause. The problem with the IN operator is that it's not efficient and the latter is more verbose. The alternating are laid out in the [filtering](../01-basics/filtering-tables.qmd) chapter.
...
<!-- TODO: maybe I could take inspo from R4DS? https://r4ds.hadley.nz/joins.html I LOVE the set theory of joins -->
