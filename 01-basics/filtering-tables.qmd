...
1. Write a SQL statement that finds people with the last name [[ come up with something where a good where condition is needed with LIKE]]
2. [[ Write a SQL statement that does a semi left join ]]
